...
export default function CareerRoadmap() {
  ...
  // ── QUIZ (shown immediately, no empty state) ──
  if (stage === "quiz") {
    return (
      <div className="roadmap-page">
        ...
        <div className="roadmap-quiz-inline">
    ...
    <div className="roadmap-page">
      ...
      <div className="roadmap-main-row">
        <div className="roadmap-wave-card">
          <div className="roadmap-wave-day-axis">
            {milestones.map((m, i) => (
              <div
                key={i}
                className={`roadmap-wave-day-axis-item ${i === activeYear ? "active" : ""}`}
                onClick={() => setActiveYear(i)}
              >
        ...
        <div className="roadmap-side-panel">
          <div className="roadmap-side-title">Roadmap</div>
          <div className="roadmap-side-subtitle">
            Based on your interest in {FIELD_INFO[answers.field]?.skill.toLowerCase()} and<br />
            preference for {WORKSTYLE_INFO[answers.workStyle]?.label.toLowerCase()}.
          </div>
